...
For TypeScript projects, [`@protokoll/abi`](packages/abi) ships the typed ABIs and the active deployment addresses:
...
packages/
  ...
  abi/              @protokoll/abi - published ABIs and addresses for integrators
